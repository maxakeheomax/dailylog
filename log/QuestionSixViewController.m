...
#import "QuestionSixDesViewController.h"
#import "QuestionSevenViewController.h"
#import "AppDelegate.h"

@interface QuestionSixViewController ()
...
-(IBAction)no:(id)sender{
    ...
    appdelegate.questionSixData  = @"No";
    UIToolbar *toolsR = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 103.0f, 44.01f)];
    toolsR.clearsContextBeforeDrawing = NO;
    toolsR.clipsToBounds = NO;
    toolsR.tintColor = [UIColor colorWithWhite:0.305f alpha:0.0f];
...
-(void)descr{
    QuestionSixDesViewController *descr = [[QuestionSixDesViewController alloc]init];
...
-(void)forward{
    QuestionSevenViewController *seventh = [[QuestionSevenViewController alloc]init];
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"Question6NavBar.png"] forBarMetrics:UIBarMetricsDefault];
}
