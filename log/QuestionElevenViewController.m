//
//  QuestionElevenViewController.m
//  dailyLog
//
...
#import "QuestionTwelveViewController.h"
#import "AppDelegate.h"

@interface QuestionElevenViewController ()

@end

@implementation QuestionElevenViewController
...
- (void)viewDidLoad
{
    questionElevenView.delegate = self;
...
-(void)forward{
    QuestionTwelveViewController *twelveth = [[QuestionTwelveViewController alloc]init];
    [self.navigationController pushViewController:twelveth animated:YES];
}
-(void)textViewDidBeginEditing:(UITextView *)textView{
    AppDelegate *appdelegate = (AppDelegate *)[[UIApplication sharedApplication]delegate];
    appdelegate.questionElevenData  = [NSString stringWithFormat:@"%@",questionElevenView.text];
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"Question11NavBar.png"] forBarMetrics:UIBarMetricsDefault];
}
