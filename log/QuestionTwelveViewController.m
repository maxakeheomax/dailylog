//
//  QuestionTwelveViewController.m
//  dailyLog
//
...
@interface QuestionTwelveViewController ()

@end

@implementation QuestionTwelveViewController
...
-(IBAction)no:(id)sender{
    ...
    appdelegate.questionTwelveData  = @"No";
    UIToolbar *toolsR = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 103.0f, 44.01f)];
    toolsR.clearsContextBeforeDrawing = NO;
    toolsR.clipsToBounds = NO;
    toolsR.tintColor = [UIColor colorWithWhite:0.305f alpha:0.0f];
...
-(void)descr{
    QuestionTwelveDesViewController *descr = [[QuestionTwelveDesViewController alloc]init];
    descr.modalTransitionStyle = UIModalTransitionStylePartialCurl;
    [self presentModalViewController:descr animated:YES];
    [self forward];
}
-(void)forward{
    PhotViewController *photo = [[PhotViewController alloc]init];
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"Question12NavBar.png"] forBarMetrics:UIBarMetricsDefault];
}
